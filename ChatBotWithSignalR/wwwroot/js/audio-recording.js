    ...
    stop: function () {
        ...
        return new Promise(resolve => {
            ...
            audioRecorder.mediaRecorder.addEventListener("stop", () => {
                ...
                setAudioFileToInputFile(audioBlob, mimeType, '');
...
function setAudioFileToInputFile(audioBlob, mimeType, other) {
    // Get a reference to our file input
    const fileInput = document.querySelector('#Files');

    let loginUserId = document.querySelector('#LoginUserId').value;
    // Create a new File object
    const myFile = new File([audioBlob], `recordingBY_${loginUserId}.webm`, {
        type: mimeType,
